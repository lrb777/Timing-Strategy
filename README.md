...
仅使用收盘价构图，忽略时间轴。每日以今日收盘价与图中**最后一根线**的高低点比较：

| 条件 | 操作 |
|------|------|
| 今日收盘 > 最后一根线高点 | 画白线（高点=今日收盘，低点=前线高点） |
| 今日收盘 < 最后一根线低点 | 画黑线（高点=前线低点，低点=今日收盘） |
| 今日收盘在最后一根线高低点之间 | 不画线 |

**转向线判断（画完后分类）：**

新画的线与前一根线颜色相反，且此前已有连续 N 根同色线 → 标记为**转向线**

- 新白线之前有 N 根连续黑线 → **白色转向线**（趋势由熊转牛）
- 新黑线之前有 N 根连续白线 → **黑色转向线**（趋势由牛转熊）
- N 默认为 3
- 趋势状态：仅在转向线出现时切换（白色转向线 = 牛市，黑色转向线 = 熊市）；首次转向线出现前为中性
